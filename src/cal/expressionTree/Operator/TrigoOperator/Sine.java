...
/**
 * The Class represents Sine operator It extends the TrigoOperator
 * 
 * @author Cal
 * 
 */
public class Sine extends TrigoOperator {
    ...
    /**
     * Constructor for Sine Operator Initialize by passing "sin" to
     * TrigoOperator to let it know it is a Sine operator
     * 
     */
    public Sine() {
	super("sin");
