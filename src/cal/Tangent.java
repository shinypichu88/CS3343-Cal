...
/**
 * The Class represents Tangent operator
...
public class Tangent extends TrigoOperator{
	...
	/**
	 * Constructor for Tangent Operator
	 * Initialize by passing "tan" to TrigoOperator to let it know it is a Tangent operator
	 * 
	 */
	public Tangent() {
		super("tan");	
