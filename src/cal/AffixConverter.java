...
public class AffixConverter {
    ...
    /**
     * Convert infix to postfix expression: 1*(22+3.33) -> 1 22 3.33 + * The
     * result is made specifically for expression tree to put into node
     * 
     * <pre>
	...
	for (int i = 0; i < infixArrayList.size(); i++) {
		...
		if (i - 1 >= 0 && infixArrayList.get(i - 1).equals(")"))
			...
			&& MathHelper.isPostfixOperator(infixArrayList
				.get(i - 1)))
		    operatorStack.push("*");
